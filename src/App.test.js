...
test('getSecretWord runs on App mount', () => {
  ...
  // set up comp with getSecredWordMock as the getSecreWord prop
  ...
  const getSecreWordCallCount = getSecretWordMock.mock.calls.length;
  expect(getSecreWordCallCount).toBe(1);
})